...
class TestPrivacy(TestCase):
    """
    Testing methods for the route to switch between a private and public account
    """
    ...
    def test_public_status(self, client):
        """
        Confirm that privacy accepts the passed status and switches between private and public
        """
        client.post(
    ...
    def test_private_status(self, client):
        """
        Confirm that privacy accepts the passed status and switches between public and private
        """
        client.post(
            "/sign_in", data={"username": "testuser", "password": "testpass"})
